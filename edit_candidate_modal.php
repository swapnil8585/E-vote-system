...
<!-- /.modal-content -->
	...
	<?php 
		...
		if(ISSET($_POST['update'])){
			...
			$conn->query("UPDATE candidate SET position = '$position', firstname = '$firstname', lastname = '$lastname', year_level = '$year_level', gender = '$gender',img='$location' WHERE candidate_id = '$candidate_id'")or die(mysql_error("Connection failed".$conn->$query));
